...
const CONDITIONS: Array<{ name: string; valued?: boolean; desc: string }> = [
  {
    name: 'Concealed',
  ...
  {
    name: 'Confused',
    desc: 'You are mentally befuddled. You cannot use reactions. You are off-guard. You must spend all your actions to Strike or use a hostile action against a randomly determined creature. If you have no valid targets, you are instead flat-footed and waste your actions.',
  },
  {
    name: 'Confused',
  ...
  // ── Attitude conditions (social; rarely relevant in combat but included for reference) ──
  {
    name: 'Friendly',
